// FORA Admin v1 — operator-plane configuration service.
//
...
// service from fora.v1.ExchangeService — the operator/config plane is not
// part of the agent hot-path contract, and keeping it out of fora.v1 keeps
...
// version" in fora.proto for the value and the single-constant rule.

// Code generated by protoc-gen-go. DO NOT EDIT.
// versions:
// 	protoc-gen-go v1.36.11
// 	protoc        (unknown)
// source: fora/admin/v1/admin.proto
...
func (x *TenantFeeRate) Reset() {
	*x = TenantFeeRate{}
	mi := &file_fora_admin_v1_admin_proto_msgTypes[0]
...
func (*TenantFeeRate) Descriptor() ([]byte, []int) {
	return file_fora_admin_v1_admin_proto_rawDescGZIP(), []int{0}
}
...
func (x *ReportingPolicy) Reset() {
	*x = ReportingPolicy{}
	mi := &file_fora_admin_v1_admin_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReportingPolicy) Descriptor() ([]byte, []int) {
	return file_fora_admin_v1_admin_proto_rawDescGZIP(), []int{1}
}
...
func (x *SetTenantFeeRateRequest) Reset() {
	*x = SetTenantFeeRateRequest{}
	mi := &file_fora_admin_v1_admin_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetTenantFeeRateRequest) Descriptor() ([]byte, []int) {
	return file_fora_admin_v1_admin_proto_rawDescGZIP(), []int{2}
}
...
func (x *SetTenantFeeRateResponse) Reset() {
	*x = SetTenantFeeRateResponse{}
	mi := &file_fora_admin_v1_admin_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetTenantFeeRateResponse) Descriptor() ([]byte, []int) {
	return file_fora_admin_v1_admin_proto_rawDescGZIP(), []int{3}
}
...
func (x *SetReportingPolicyRequest) Reset() {
	*x = SetReportingPolicyRequest{}
	mi := &file_fora_admin_v1_admin_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetReportingPolicyRequest) Descriptor() ([]byte, []int) {
	return file_fora_admin_v1_admin_proto_rawDescGZIP(), []int{4}
}
...
func (x *SetReportingPolicyResponse) Reset() {
	*x = SetReportingPolicyResponse{}
	mi := &file_fora_admin_v1_admin_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetReportingPolicyResponse) Descriptor() ([]byte, []int) {
	return file_fora_admin_v1_admin_proto_rawDescGZIP(), []int{5}
}
...
const file_fora_admin_v1_admin_proto_rawDesc = "" +
	"\n" +
	"\x19fora/admin/v1/admin.proto\x12\rfora.admin.v1\x1a\x1bbuf/validate/validate.proto\"\x95\x01\n" +
	"\rTenantFeeRate\x12'\n" +
	...
	"\x04rate\x18\x02 \x01(\v2\x1c.fora.admin.v1.TenantFeeRateB\x06\xbaH\x03\xc8\x01\x01R\x04rate\"f\n" +
	"\x18SetTenantFeeRateResponse\x12\x10\n" +
	"\x03ver\x18\x01 \x01(\tR\x03ver\x128\n" +
	"\x04rate\x18\x02 \x01(\v2\x1c.fora.admin.v1.TenantFeeRateB\x06\xbaH\x03\xc8\x01\x01R\x04rate\"m\n" +
	"\x19SetReportingPolicyRequest\x12\x10\n" +
	"\x03ver\x18\x01 \x01(\tR\x03ver\x12>\n" +
	"\x06policy\x18\x02 \x01(\v2\x1e.fora.admin.v1.ReportingPolicyB\x06\xbaH\x03\xc8\x01\x01R\x06policy\"n\n" +
	"\x1aSetReportingPolicyResponse\x12\x10\n" +
	"\x03ver\x18\x01 \x01(\tR\x03ver\x12>\n" +
	"\x06policy\x18\x02 \x01(\v2\x1e.fora.admin.v1.ReportingPolicyB\x06\xbaH\x03\xc8\x01\x01R\x06policy2\xde\x01\n" +
	"\fAdminService\x12c\n" +
	"\x10SetTenantFeeRate\x12&.fora.admin.v1.SetTenantFeeRateRequest\x1a'.fora.admin.v1.SetTenantFeeRateResponse\x12i\n" +
	"\x12SetReportingPolicy\x12(.fora.admin.v1.SetReportingPolicyRequest\x1a).fora.admin.v1.SetReportingPolicyResponseB\xb9\x01\n" +
	"\x11com.fora.admin.v1B\n" +
	"AdminProtoP\x01ZBgithub.com/FORA-Protocol/protocol/gen/go/fora/admin/v1;foraadminv1\xa2\x02\x03FAX\xaa\x02\rFora.Admin.V1\xca\x02\rFora\\Admin\\V1\xe2\x02\x19Fora\\Admin\\V1\\GPBMetadata\xea\x02\x0fFora::Admin::V1b\x06proto3"

var (
	file_fora_admin_v1_admin_proto_rawDescOnce sync.Once
	file_fora_admin_v1_admin_proto_rawDescData []byte
)

func file_fora_admin_v1_admin_proto_rawDescGZIP() []byte {
	file_fora_admin_v1_admin_proto_rawDescOnce.Do(func() {
		file_fora_admin_v1_admin_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_fora_admin_v1_admin_proto_rawDesc), len(file_fora_admin_v1_admin_proto_rawDesc)))
	})
	return file_fora_admin_v1_admin_proto_rawDescData
}

var file_fora_admin_v1_admin_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_fora_admin_v1_admin_proto_goTypes = []any{
	(*TenantFeeRate)(nil),              // 0: fora.admin.v1.TenantFeeRate
	(*ReportingPolicy)(nil),            // 1: fora.admin.v1.ReportingPolicy
	(*SetTenantFeeRateRequest)(nil),    // 2: fora.admin.v1.SetTenantFeeRateRequest
	(*SetTenantFeeRateResponse)(nil),   // 3: fora.admin.v1.SetTenantFeeRateResponse
	(*SetReportingPolicyRequest)(nil),  // 4: fora.admin.v1.SetReportingPolicyRequest
	(*SetReportingPolicyResponse)(nil), // 5: fora.admin.v1.SetReportingPolicyResponse
}
var file_fora_admin_v1_admin_proto_depIdxs = []int32{
	0, // 0: fora.admin.v1.SetTenantFeeRateRequest.rate:type_name -> fora.admin.v1.TenantFeeRate
	0, // 1: fora.admin.v1.SetTenantFeeRateResponse.rate:type_name -> fora.admin.v1.TenantFeeRate
	1, // 2: fora.admin.v1.SetReportingPolicyRequest.policy:type_name -> fora.admin.v1.ReportingPolicy
	1, // 3: fora.admin.v1.SetReportingPolicyResponse.policy:type_name -> fora.admin.v1.ReportingPolicy
	2, // 4: fora.admin.v1.AdminService.SetTenantFeeRate:input_type -> fora.admin.v1.SetTenantFeeRateRequest
	4, // 5: fora.admin.v1.AdminService.SetReportingPolicy:input_type -> fora.admin.v1.SetReportingPolicyRequest
	3, // 6: fora.admin.v1.AdminService.SetTenantFeeRate:output_type -> fora.admin.v1.SetTenantFeeRateResponse
	5, // 7: fora.admin.v1.AdminService.SetReportingPolicy:output_type -> fora.admin.v1.SetReportingPolicyResponse
...
func init() { file_fora_admin_v1_admin_proto_init() }
func file_fora_admin_v1_admin_proto_init() {
	if File_fora_admin_v1_admin_proto != nil {
		return
	}
	file_fora_admin_v1_admin_proto_msgTypes[0].OneofWrappers = []any{}
	file_fora_admin_v1_admin_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_fora_admin_v1_admin_proto_rawDesc), len(file_fora_admin_v1_admin_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_fora_admin_v1_admin_proto_goTypes,
		DependencyIndexes: file_fora_admin_v1_admin_proto_depIdxs,
		MessageInfos:      file_fora_admin_v1_admin_proto_msgTypes,
	}.Build()
	File_fora_admin_v1_admin_proto = out.File
	file_fora_admin_v1_admin_proto_goTypes = nil
	file_fora_admin_v1_admin_proto_depIdxs = nil
}
