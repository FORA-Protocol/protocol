...
package forav1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1 "github.com/FORA-Protocol/protocol/gen/go/fora/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ExchangeServiceDiscoverResourcesProcedure = "/fora.v1.ExchangeService/DiscoverResources"
	// ExchangeServiceExecuteTransactionProcedure is the fully-qualified name of the ExchangeService's
	// ExecuteTransaction RPC.
	ExchangeServiceExecuteTransactionProcedure = "/fora.v1.ExchangeService/ExecuteTransaction"
	// ExchangeServiceReportUsageProcedure is the fully-qualified name of the ExchangeService's
	// ReportUsage RPC.
	ExchangeServiceReportUsageProcedure = "/fora.v1.ExchangeService/ReportUsage"
	// ExchangeServiceDisputeTransactionProcedure is the fully-qualified name of the ExchangeService's
	// DisputeTransaction RPC.
	ExchangeServiceDisputeTransactionProcedure = "/fora.v1.ExchangeService/DisputeTransaction"
	...
	ExchangeServiceRequestDomainVerificationProcedure = "/fora.v1.ExchangeService/RequestDomainVerification"
	...
	ExchangeServiceConfirmDomainVerificationProcedure = "/fora.v1.ExchangeService/ConfirmDomainVerification"
	// ExchangeServiceRegisterProcedure is the fully-qualified name of the ExchangeService's Register
	// RPC.
	ExchangeServiceRegisterProcedure = "/fora.v1.ExchangeService/Register"
	// ExchangeServiceGetAccountStatusProcedure is the fully-qualified name of the ExchangeService's
	// GetAccountStatus RPC.
	ExchangeServiceGetAccountStatusProcedure = "/fora.v1.ExchangeService/GetAccountStatus"
	// CatalogServicePushResourcesProcedure is the fully-qualified name of the CatalogService's
	// PushResources RPC.
	CatalogServicePushResourcesProcedure = "/fora.v1.CatalogService/PushResources"
	// CatalogServiceRemoveResourcesProcedure is the fully-qualified name of the CatalogService's
	// RemoveResources RPC.
	CatalogServiceRemoveResourcesProcedure = "/fora.v1.CatalogService/RemoveResources"
...
// NewExchangeServiceClient constructs a client for the fora.v1.ExchangeService service. By default,
...
func NewExchangeServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ExchangeServiceClient {
	...
	exchangeServiceMethods := v1.File_fora_v1_fora_proto.Services().ByName("ExchangeService").Methods()
...
// DiscoverResources calls fora.v1.ExchangeService.DiscoverResources.
...
// ExecuteTransaction calls fora.v1.ExchangeService.ExecuteTransaction.
...
// ReportUsage calls fora.v1.ExchangeService.ReportUsage.
...
// DisputeTransaction calls fora.v1.ExchangeService.DisputeTransaction.
...
// RequestDomainVerification calls fora.v1.ExchangeService.RequestDomainVerification.
...
// ConfirmDomainVerification calls fora.v1.ExchangeService.ConfirmDomainVerification.
...
// Register calls fora.v1.ExchangeService.Register.
...
// GetAccountStatus calls fora.v1.ExchangeService.GetAccountStatus.
...
// ExchangeServiceHandler is an implementation of the fora.v1.ExchangeService service.
...
func NewExchangeServiceHandler(svc ExchangeServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/fora.v1.ExchangeService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedExchangeServiceHandler) DiscoverResources(context.Context, *connect.Request[v1.ResourceQuery]) (*connect.Response[v1.ResourceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("fora.v1.ExchangeService.DiscoverResources is not implemented"))
}
...
func (UnimplementedExchangeServiceHandler) ExecuteTransaction(context.Context, *connect.Request[v1.TransactionRequest]) (*connect.Response[v1.TransactionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("fora.v1.ExchangeService.ExecuteTransaction is not implemented"))
}
...
func (UnimplementedExchangeServiceHandler) ReportUsage(context.Context, *connect.Request[v1.UsageReport]) (*connect.Response[v1.UsageReportResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("fora.v1.ExchangeService.ReportUsage is not implemented"))
}
...
func (UnimplementedExchangeServiceHandler) DisputeTransaction(context.Context, *connect.Request[v1.DisputeRequest]) (*connect.Response[v1.DisputeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("fora.v1.ExchangeService.DisputeTransaction is not implemented"))
}
...
func (UnimplementedExchangeServiceHandler) RequestDomainVerification(context.Context, *connect.Request[v1.DomainVerificationRequest]) (*connect.Response[v1.DomainVerificationChallenge], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("fora.v1.ExchangeService.RequestDomainVerification is not implemented"))
}
...
func (UnimplementedExchangeServiceHandler) ConfirmDomainVerification(context.Context, *connect.Request[v1.DomainVerificationConfirmation]) (*connect.Response[v1.DomainVerificationResult], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("fora.v1.ExchangeService.ConfirmDomainVerification is not implemented"))
}
...
func (UnimplementedExchangeServiceHandler) Register(context.Context, *connect.Request[v1.RegisterRequest]) (*connect.Response[v1.RegisterResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("fora.v1.ExchangeService.Register is not implemented"))
}
...
func (UnimplementedExchangeServiceHandler) GetAccountStatus(context.Context, *connect.Request[v1.GetAccountStatusRequest]) (*connect.Response[v1.GetAccountStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("fora.v1.ExchangeService.GetAccountStatus is not implemented"))
}

// CatalogServiceClient is a client for the fora.v1.CatalogService service.
...
// NewCatalogServiceClient constructs a client for the fora.v1.CatalogService service. By default,
// it uses the Connect protocol with the binary Protobuf Codec, asks for gzipped responses, and
// sends uncompressed requests. To use the gRPC or gRPC-Web protocols, supply the connect.WithGRPC()
// or connect.WithGRPCWeb() options.
//
...
func NewCatalogServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CatalogServiceClient {
	baseURL = strings.TrimRight(baseURL, "/")
	catalogServiceMethods := v1.File_fora_v1_fora_proto.Services().ByName("CatalogService").Methods()
...
// PushResources calls fora.v1.CatalogService.PushResources.
...
// RemoveResources calls fora.v1.CatalogService.RemoveResources.
...
// RefreshCatalog calls fora.v1.CatalogService.RefreshCatalog.
...
// CatalogServiceHandler is an implementation of the fora.v1.CatalogService service.
...
func NewCatalogServiceHandler(svc CatalogServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/fora.v1.CatalogService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedCatalogServiceHandler) PushResources(context.Context, *connect.Request[v1.PushResourcesRequest]) (*connect.Response[v1.PushResourcesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("fora.v1.CatalogService.PushResources is not implemented"))
}
...
func (UnimplementedCatalogServiceHandler) RemoveResources(context.Context, *connect.Request[v1.RemoveResourcesRequest]) (*connect.Response[v1.RemoveResourcesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("fora.v1.CatalogService.RemoveResources is not implemented"))
}
...
func (UnimplementedCatalogServiceHandler) RefreshCatalog(context.Context, *connect.Request[v1.RefreshCatalogRequest]) (*connect.Response[v1.RefreshCatalogResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("fora.v1.CatalogService.RefreshCatalog is not implemented"))
}

// BrokerServiceClient is a client for the fora.v1.BrokerService service.
...
func NewBrokerServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) BrokerServiceClient {
	baseURL = strings.TrimRight(baseURL, "/")
	brokerServiceMethods := v1.File_fora_v1_fora_proto.Services().ByName("BrokerService").Methods()
