...
The FORA Connect wire is snake_case proto-JSON with ``EmitUnpopulated``: zero-valued
...
:func:`fora_sdk.core.canonical_offer_payload` strips them on the way into JCS. Every
