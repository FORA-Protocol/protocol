"""The blocking facade over the FORA client — for scripts, notebooks and synchronous apps.

Same verbs, same names, same contracts as :mod:`fora_sdk.client`; the only difference is
...
from fora_sdk.client._verbs import ClientConfig
...
class _Face:
    ...
    one. See :class:`fora_sdk.client._Face`.
    """
...
class Client(_Face):
    """The blocking Exchange client. See :class:`fora_sdk.client.Client` for the contract."""
...
class BrokerClient(_Face):
    """The blocking Broker client. See :class:`fora_sdk.client.BrokerClient`."""
...
class CatalogClient(_Face):
    """The blocking Catalog client. See :class:`fora_sdk.client.CatalogClient`."""
