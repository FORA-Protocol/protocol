"""sdk/python/fora_sdk/core — the transport-neutral L2 core.
...
framework bindings (fora_sdk.signing_transport) depend one-directionally on this core,
...
class Verifier:
    ...
    def _expired(self, offer: dict[str, Any]) -> bool:
        ...
        # — FORA offers are minted now+TTL, so a missing/broken bound is malformed
