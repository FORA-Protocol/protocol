...
// Offer authenticity (ADR-020 §4, fora.proto Offer.signature). An Exchange signs
...
// fora.proto Offer.signature. The returned bytes are byte-identical to what
...
// Offer.signature comment in fora.proto defines normatively: snake_case proto field
...
// once in the fora.proto Offer.signature comment; it is not restated here. VerifyOffer
...
func CanonicalOfferBytes(offer *forav1.Offer) ([]byte, error) {
	...
	clone, ok := proto.Clone(offer).(*forav1.Offer)
	if !ok {
