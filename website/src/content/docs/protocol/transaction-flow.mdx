...
description: "The four Exchange RPCs that form the core FORA protocol: DiscoverResources, ExecuteTransaction, ReportUsage, and DisputeTransaction."
---
...
- FORA `Pricing` with the rate, currency, and normalized unit_cost
