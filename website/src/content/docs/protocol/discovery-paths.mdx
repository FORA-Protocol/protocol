...
description: "Six paths an AI agent can take to discover and enter the FORA protocol flow, from proactive fora.json lookup to subscription-based access."
---
...
sequenceDiagram
    ...
    Agent->>PUB: GET /.well-known/fora.json
...
sequenceDiagram
    participant Agent as AI Agent
    participant Orch as FORA Broker
