...
result, err := fora.Fetch(ctx, "https://techcrunch.com/2026/03/19/ai-agents-commerce.html")
// result.Cost = 0.05
// result.SubscriptionID = ""

// Scenario B: delegation present — SDK includes the delegation JWT in Requester.delegation
result, err := fora.Fetch(ctx, "https://marketdata.example.com/earnings/NVDA/2026-Q1-transcript")
// result.Cost = 0.00
...
```go
client := fora.NewClient(fora.Config{
    AgentID:   "hedge-bot",
    Domain:    "hedgefund.com",
