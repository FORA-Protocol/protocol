...
- Enforcement is **NOT mandatory**: a bearer-only signed-URL CDN that cannot run code falls back to HMAC + short TTL + TLS. FORA reference implementations run on edge functions and **do** enforce it.
