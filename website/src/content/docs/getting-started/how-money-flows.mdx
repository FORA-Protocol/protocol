...
description: "The FORA billing chain, pricing models, unit_cost normalization, and a concrete example transaction with dollar amounts."
---

## The Billing Chain

FORA never touches money. It follows the OpenRTB model: the protocol handles authorization and logging, while actual settlement happens outside the protocol through existing billing infrastructure.
...
- [Industry Landscape](/getting-started/industry-landscape/) -- how FORA fits among competing approaches
