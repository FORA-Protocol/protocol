...
description: "ACME-style domain verification, CDN key provisioning, and catalog contributor setup for FORA providers"
---
...
fora-cli key generate --cdn cloudfront --algorithm ecdsa-p256

# Akamai (HMAC-SHA256)
fora-cli key generate --cdn akamai

# Fastly (HMAC-SHA256)
fora-cli key generate --cdn fastly
```
...
fora-cli key push \
  ...
  --cdn cloudfront \
  --key-file ./fora-cloudfront-private.pem
```
...
- [Proto: FORA v1](/reference/proto-fora/) -- `DomainVerification*` message reference
