---
title: "What Is FORA?"
description: "An introduction to the Federated Open Resource Access — the open transaction layer for fast, metered access to any digital resource by AI agents."
---
...
FORA — the **Federated Open Resource Access** — is an open transaction layer for metered resource access by AI agents. One protocol for discovering, pricing, transacting, delivering, and verifying any digital resource.
...
A FORA transaction follows six steps:

```
1. Discover    Agent checks /.well-known/fora.json → finds Exchange endpoint
...
FORA was validated across **18 real-world scenarios** spanning 10 industries:
...
| **Standard extensions** | Cross-domain conventions in `fora.*` namespace | `fora.compliance.dua_required` |
...
FORA covers **metered access to resources that exist**. The test: "Does the resource exist before the transaction?"
...
- [For Resource Providers](/getting-started/for-providers/) — how to expose your resources through FORA
- [For AI Agents](/getting-started/for-ai-agents/) — how to access resources through FORA
- [For Exchange Operators](/getting-started/for-exchange-operators/) — how to run a FORA Exchange
- [How Money Flows](/getting-started/how-money-flows/) — the billing chain, pricing models, and settlement
- [Standards Layering](/protocol/standards-layering/) — how RSL, CoMP, and FORA work together
