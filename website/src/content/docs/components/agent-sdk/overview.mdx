...
| TypeScript | [`gen/ts/`](https://github.com/FORA-Protocol/protocol/tree/main/gen/ts/) (types) + [`sdk/ts/`](https://github.com/FORA-Protocol/protocol/tree/main/sdk/ts/) (hand-written SDK: `src`, `core`, `resolvers`, `client`, `hono`) | Shipped; published to npm as [`@fora-protocol/sdk`](https://www.npmjs.com/package/@fora-protocol/sdk) :sdk-version | `zod` + `undici` + `ajv` + `canonicalize` (`hono` optional) |
| Python | [`gen/python/`](https://github.com/FORA-Protocol/protocol/tree/main/gen/python/) (types) + [`sdk/python/`](https://github.com/FORA-Protocol/protocol/tree/main/sdk/python/) (hand-written SDK: `fora_sdk`, `fora_sdk.core`, `fora_sdk.resolvers`, `fora_sdk.client`, `fora_sdk.sync`) | Shipped; published to PyPI as [`fora-protocol-sdk`](https://pypi.org/project/fora-protocol-sdk/) :sdk-version | `pydantic` + `httpx` + `cryptography` |
