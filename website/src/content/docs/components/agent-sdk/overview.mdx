...
const client = createClient(baseURL, {
  ...
  requester,
  resolveOfferKey: async (exchange) => offerKeys.get(exchange),
...
endpoints = WellKnownEndpointResolver()
