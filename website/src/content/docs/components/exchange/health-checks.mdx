---
title: "Health Checks"
description: "Three-layer health checking for the FORA Exchange -- gRPC health, HTTP liveness, and HTTP readiness with subsystem health matrix."
---
...
| **readinessProbe** | gRPC `fora.v1.ExchangeService` | Once started, use gRPC-native probing. Removes pod from Service endpoints when unhealthy |
