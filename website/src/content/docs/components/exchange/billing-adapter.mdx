...
type SubscriptionStatus struct {
    ...
    UnitValue      *forav1.Cost // for subscription_unit_value (ASC 606 prepaid drawdown)
}
...
func (tc *TenantCatalog) resolvePrice(path string) *forav1.Pricing {
