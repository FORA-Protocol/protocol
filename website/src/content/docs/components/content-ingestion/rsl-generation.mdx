...
The RSL generator produces valid RSL 1.0 XML from the compiled catalog. It maps FORA protocol objects back to RSL elements:
...
| FORA PricingModel | RSL Payment Type |
|---|---|
...
## FORA Sitemap Namespace (XSD)

The formal schema definition for the FORA sitemap namespace extension:

```xml
<?xml version="1.0" encoding="UTF-8"?>
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema"
           xmlns:fora="https://fora.dev/sitemap/1.0"
           targetNamespace="https://fora.dev/sitemap/1.0"
           elementFormDefault="qualified">

  <xs:annotation>
    <xs:documentation>
      FORA Sitemap Extension Schema v1.0
      Extends standard Sitemap 0.9 with content monetization metadata.
      Namespace: https://fora.dev/sitemap/1.0
    </xs:documentation>
  </xs:annotation>
  ...
  <xs:element name="content">
    <xs:complexType>
      <xs:all>
        ...
        <xs:element name="pricing-model" type="fora:pricingModelType" minOccurs="0"/>
        <xs:element name="rate" type="fora:rateType" minOccurs="0"/>
        <xs:element name="permits" type="xs:string" minOccurs="0"/>
        <xs:element name="prohibits" type="xs:string" minOccurs="0"/>
        <xs:element name="content-type" type="fora:contentTypeType" minOccurs="0"/>
        <xs:element name="author" type="xs:string" minOccurs="0"/>
        <xs:element name="source-type" type="fora:sourceTypeType" minOccurs="0"/>
      </xs:all>
    </xs:complexType>
  </xs:element>
